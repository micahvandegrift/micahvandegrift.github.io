...
# Current
---
Micah Vandegrift is a highly effective strategic leader and innovator dedicated to building and guiding high-performing teams that transform strategy into actionable solutions. His expertise centers on putting the user or customer first and driving organizational efficiency through communication and collaboration. 

Micah consistently accelerates results through innovation, most recently by implementing AI integrations that improved team efficiency by 75% and streamlining client onboarding processes for 63% faster completion. Earlier in his career, he served as a Fulbright Scholar in Europe and directed a digital art program sponsored by a $414,000 grant from the Andrew W. Mellon Foundation. He has led multidisciplinary strategy and research teams, and his career is defined by his commitment to maximizing the public impact and accessibility of knowledge.
...
## Long
---
Micah Vandegrift is a strategic leader and innovator dedicated to building and guiding high-performing teams that transform complex strategy into actionable solutions across the science, technology, and research sectors. As a Client Configuration and Support Lead at Digital Science, he applies his expertise in user-centered design and digital infrastructure to drive business efficiency. He has initiated AI integrations that improved team efficiency and AI utility by 75% and streamlined client onboarding processes for 63.5% faster completion.

Micah’s unique career is rooted in maximizing the accessibility and public impact of knowledge. He previously served as a Senior Strategist and Team Lead for the NIH’s All of Us Research Program, where he directed a multidisciplinary strategy team to pinpoint user pain points, resulting in a 45% reduction in onboarding time. Prior to this, he was NC State University’s Open Knowledge Librarian and the Lead Principal Investigator for a $414,000 grant from the Andrew W. Mellon Foundation, pioneering a tech accelerator that launched 50% of incubated projects. He also served as a Fulbright-Schuman Research Scholar in Europe, studying open science policy and infrastructure.
